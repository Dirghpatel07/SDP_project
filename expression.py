...
#loading of cascade
face_classifier = cv2.CascadeClassifier(r'E:\Musicapp\haarcascade_frontalface_default.xml')
classifier =load_model(r'E:\Musicapp\Emotion_little_vgg.h5')
