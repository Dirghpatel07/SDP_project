...
root=Tk()
# fav icon
root.iconbitmap(r'E:\Musicapp\images\music_icon.ico')
global paused
paused=False 
...
os.chdir(f'E:/Musicapp/songs/{f.read()}_songs')
...
back_button_img=PhotoImage(file=r'E:\Musicapp\images\buttons\backward.png')
foward_button_img=PhotoImage(file=r'E:\Musicapp\images\buttons\forward.png') 
play_button_img=PhotoImage(file=r'E:\Musicapp\images\buttons\play.png')
pause_button_img=PhotoImage(file=r'E:\Musicapp\images\buttons\pause.png')
stop_button_img=PhotoImage(file=r'E:\Musicapp\images\buttons\stop.png')
